...
export default function Player2() {
  ...
  const attackEnemy = (move: string) => {
    ...
    ws.send(
      JSON.stringify({ type: "move", attacker: "pokemon2", movename: move }),
    );
  };
  ...
  return (
    <div className="maindiv">
        ...
        <div className="player2">
          ...
          >
            <div className="pokemon2img">
              {pokemonImg2 ? (
                <img src={pokemonImg2} height="350px" width="350px" alt="you" />
              ) : (
                <div>no img</div>
              )}
            </div>
      ...
      <div className="infodiv">
        <div className="text">
          {gameOver ? (
            <p>{(pokemon2Stats?.name ?? "Pokemon").toUpperCase()} fainted...</p>
